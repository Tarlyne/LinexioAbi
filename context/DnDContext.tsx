...
interface DnDContextType {
  ...
  startDrag: (id: string, type: 'exam' | 'teacher', event: React.PointerEvent, extraData?: any, ghostContent?: React.ReactNode) => void;
...
export const DnDProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const startDrag = useCallback((id: string, type: 'exam' | 'teacher', event: React.PointerEvent, extraData?: any, ghostContent?: React.ReactNode) => {
