      ...
      <div className="flex flex-col h-[85vh]">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-700/30 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-cyan-500/80 font-medium">Prüfungsübersicht nach Personen</p>
            </div>
          </div>
          ...
          <table className="w-full border-collapse text-left bg-slate-900/40">
            ...
            <tbody>
              {filteredStudents.map(student => (
                <tr key={student.id} className="hover:bg-white/5 transition-colors border-b border-slate-800/40 last:border-b-0">
                  ...
                  <td colSpan={maxExamsCount + 1} className="px-6 py-24 text-center">
                    <div className="flex flex-col items-center justify-center gap-4 text-slate-600">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm italic">Verfeinere deine Suche oder lösche den Suchbegriff.</p>
                      </div>
                    </div>
                  </td>
                </tr>
        ...
        <div className="mt-auto pt-6 border-t border-slate-700/30 shrink-0">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Planungs-Übersicht</h4>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
              {stats.subjects.slice(0, 6).map(([name, count]) => (
                <div key={name} className="flex items-center gap-4 px-3.5 py-2.5 bg-slate-900/60 border border-cyan-500/30 rounded-xl">
