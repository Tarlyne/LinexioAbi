...
import { 
  MapPin, Printer, Upload, Layers, ChevronDown, UserCheck
} from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full gap-4 overflow-hidden select-none print:hidden">
      ...
      <PlanningExportModal 
        ...
        appState={{ teachers, students, rooms, days, subjects, exams, supervisions, collectedExamIds: [], isLocked: false, masterPassword: null, settings: { autoLockMinutes: 10 }, lastUpdate: Date.now() }} 
      />
