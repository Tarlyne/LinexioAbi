...
import { BookOpen, MapPin, ChevronRight, CheckCircle2, AlertTriangle, Info, Clock, Users, X } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 overflow-hidden">
          ...
          <div className="space-y-6 flex flex-col h-full">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Raum-Belegung & Prognose</span>
            </div>
                ...
                return (
                  <div key={room.id} className={`p-4 rounded-2xl border transition-all ${
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          ...
                          <span className="text-[10px] font-bold text-amber-500/80">Gesamt: {total}</span>
                        </div>
                      </div>
                    ...
                    <div className="flex items-end justify-between border-t border-slate-800 pt-3 mt-1">
                      <div className="flex flex-col">
                        <span className="text-[9px] text-slate-500 font-bold uppercase mb-0.5 tracking-tight">Max. Peak</span>
                        <span className={`text-2xl font-black ${isOverloaded ? 'text-red-400' : isWarning ? 'text-amber-400' : 'text-emerald-400'}`}>
                          {stat.peak}
                        </span>
                      </div>
                      <div className="flex flex-col text-right">
                        <span className="text-[9px] text-slate-500 font-bold uppercase mb-0.5 tracking-tight">Zeitpunkt</span>
                        <span className="text-sm font-bold text-white tracking-tight">{stat.time} Uhr</span>
                      </div>
                    </div>
