    ...
    <div className="flex flex-col h-screen w-full dashboard-gradient select-none relative">
      ...
      <div className="aurora-container print:hidden">
        ...
        <div
          ...
          style={{ top: '40%', right: '-30%', animationDelay: '-15s', opacity: 0.15 }}
        ></div>
      </div>
          ...
          <div className="flex-1 flex flex-col gap-1 overflow-y-auto no-scrollbar">
            {navItems.map((item) => (
              ...
              >
                ...
                <div
                  className={`flex-1 transition-all duration-300 overflow-hidden whitespace-nowrap text-left ${
                    isCollapsed
            ...
            <div
              className={`transition-all duration-500 ease-in-out overflow-hidden mb-2 ${
