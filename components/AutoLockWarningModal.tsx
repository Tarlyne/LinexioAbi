    ...
    <Modal isOpen={isLockWarningVisible} onClose={() => {}} maxWidth="max-w-md">
      <div className="flex flex-col items-center text-center space-y-6 py-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-400">Aufgrund von Inaktivität wird das System in Kürze automatisch gesperrt.</p>
        </div>
        ...
        <div className="w-full bg-slate-900/50 p-4 rounded-2xl border border-slate-800 flex items-center justify-center gap-4">
          ...
          <span className="text-sm font-black text-white uppercase tracking-widest">Sperrung in {lockCountdown}s</span>
        </div>
        ...
        <div className="w-full flex flex-col gap-3">
          ...
          <button onClick={lock} className="text-slate-500 hover:text-red-400 text-xs font-bold uppercase py-2">
